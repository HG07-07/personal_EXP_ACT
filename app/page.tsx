...
import { ArrowRight, BarChart3, CreditCard, DollarSign, LineChart, Receipt, Shield } from "lucide-react"
        ...
        <div className="container px-4 py-20 md:py-32 mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6">
              Simplify Your <span className="text-primary">Personal Finances</span>
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground mb-10 max-w-2xl mx-auto">
              Track expenses, manage budgets, and gain financial insights with our intuitive expense management
              platform.
            </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="relative group">
            ...
            <div className="relative backdrop-blur-md bg-background/50 border border-border/50 rounded-3xl p-8 h-full shadow-lg hover:shadow-xl transition duration-300">
              ...
              <p className="text-muted-foreground mb-4">
                Effortlessly track and categorize your expenses with receipt scanning and automatic categorization.
              </p>
              <Link href="/dashboard/expenses" className="text-primary font-medium inline-flex items-center">
          ...
          <div className="relative group">
            ...
            <div className="relative backdrop-blur-md bg-background/50 border border-border/50 rounded-3xl p-8 h-full shadow-lg hover:shadow-xl transition duration-300">
              ...
              <p className="text-muted-foreground mb-4">
                Create and manage budgets for different categories and track your spending against them.
              </p>
              <Link href="/dashboard/budgets" className="text-blue-500 font-medium inline-flex items-center">
                Learn more <ArrowRight className="ml-1 h-4 w-4" />
              </Link>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative backdrop-blur-md bg-background/50 border border-border/50 rounded-3xl p-8 h-full shadow-lg hover:shadow-xl transition duration-300">
              ...
              <p className="text-muted-foreground mb-4">
                Gain valuable insights into your spending habits with detailed reports and visualizations.
              </p>
              <Link href="/dashboard/reports" className="text-purple-500 font-medium inline-flex items-center">
                Learn more <ArrowRight className="ml-1 h-4 w-4" />
              </Link>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative backdrop-blur-md bg-background/50 border border-border/50 rounded-3xl p-8 h-full shadow-lg hover:shadow-xl transition duration-300">
              ...
              <p className="text-muted-foreground mb-4">
                Track your financial progress over time and identify spending patterns to optimize your budget.
              </p>
              <Link href="/dashboard/reports/insights" className="text-green-500 font-medium inline-flex items-center">
                Learn more <ArrowRight className="ml-1 h-4 w-4" />
              </Link>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative backdrop-blur-md bg-background/50 border border-border/50 rounded-3xl p-8 h-full shadow-lg hover:shadow-xl transition duration-300">
              ...
              <p className="text-muted-foreground mb-4">
                Connect and manage multiple payment methods and accounts in one place for comprehensive tracking.
              </p>
              <Link href="/dashboard/payment-methods" className="text-yellow-500 font-medium inline-flex items-center">
                Learn more <ArrowRight className="ml-1 h-4 w-4" />
              </Link>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative backdrop-blur-md bg-background/50 border border-border/50 rounded-3xl p-8 h-full shadow-lg hover:shadow-xl transition duration-300">
              ...
              <Link href="/dashboard/settings" className="text-red-500 font-medium inline-flex items-center">
                Learn more <ArrowRight className="ml-1 h-4 w-4" />
              </Link>
            </div>
          </div>
          ...
          <div className="relative backdrop-blur-md bg-background/30 border border-border/50 rounded-3xl p-8 md:p-12 shadow-lg">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <blockquote className="text-xl md:text-2xl italic mb-6">
                "ExpenseEase has completely transformed how I manage my finances. The insights and budgeting tools have
                helped me save over $500 per month!"
              </blockquote>
